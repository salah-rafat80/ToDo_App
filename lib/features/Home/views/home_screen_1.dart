...
class HomeScreen1 extends StatefulWidget {
  const HomeScreen1({super.key,required this.profileName});
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Get.to(OptionsScreen(profileName: widget.profileName,));
                            },
                            child: UserData_Container(Name: widget.profileName),
                          ),
                          SizedBox(
                            width: 24,
                            height: 24,
                            child: PlusButton(name: widget.profileName),
                          ),
                        ],
                      ),
                    ),
